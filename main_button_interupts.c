...
static int8_t pushedButton = -1;
static uint8_t butState;
...
void
GPIO_Port_DOWN_IntHandler(void)
{

}

void
GPIO_Port_LEFT_IntHandler(void)
{
...
main(void)
{
    ...
    initButtons ();
    GPIOIntRegister(UP_BUT_PORT_BASE, GPIO_Port_UP_IntHandler);
    GPIOIntRegister(DOWN_BUT_PORT_BASE, GPIO_Port_DOWN_IntHandler);
    GPIOIntRegister(LEFT_BUT_PORT_BASE, GPIO_Port_LEFT_IntHandler);
    GPIOIntEnable(UP_BUT_PORT_BASE, UP_BUT_PIN);
    GPIOIntTypeSet(UP_BUT_PORT_BASE, UP_BUT_PIN, GPIO_RISING_EDGE);
    GPIOIntTypeSet(UP_BUT_PORT_BASE, UP_BUT_PIN, GPIO_HIGH_LEVEL);
	...
	while (1)
	{
		...
		if (pushedButton == UP/*butState == PUSHED*/) {
